...
// Type-safe component with full emoji path support
type ConversaQuestionProps = {
  question: Question;
  onBack?: () => void;
...
export default function ConversaQuestion({
  question,
  onBack,
  onSubmit,
  onNext,
  isAnswered = false,
}: ConversaQuestionProps) {
        ...
        >
          ...
          <div className="px-6 py-6">
            ...
            >
              ...
              <h1 className="text-white text-lg font-bold flex-1 text-center">
                {question.title || "Grammar and Vocabulary"}
              </h1>
              <div className="w-7" />
            </div>
          </div>
          ...
          <div className="px-6 py-8 space-y-6">
            ...
            <div className="flex gap-4 items-start">
              <div className="flex-shrink-0 w-[72px] h-[72px] rounded-lg bg-gradient-to-br from-amber-400 to-amber-500 flex items-center justify-center shadow-lg">
                {question.icon1_path ? (
                  <img
                    src={question.icon1_path}
                    alt="emoji"
                    className="w-full h-full object-cover animate-emoji-pop"
                    style={{ opacity: 1 }}
                  />
                ) : (
              ...
              <div className="flex-1 bg-white rounded-2xl px-5 py-4 text-gray-900 shadow-lg">
                <p
                  style={{
                    fontSize: "17px",
                    fontWeight: "500",
                ...
                >
                  {hasVocab && highlightedWords.length > 0 ? (
                    <HighlightText text={question.content.part1} activeWords={highlightedWords} />
                  ) : (
                    question.content.part1
                  )}
                </p>
              </div>
            </div>
            ...
            <div className="relative flex items-center gap-4">
              <div className="flex-1 bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl px-5 py-4 text-white shadow-lg">
                <p
                  style={{
                    fontSize: "17px",
                    fontWeight: "500",
                ...
                >
                  {hasVocab && highlightedWords.length > 0 ? (
                    <HighlightText text={question.content.part2} activeWords={highlightedWords} />
                  ) : (
                    question.content.part2
                  )}
                </p>
              </div>
              <div
                className="flex-shrink-0 flex items-center justify-center w-[72px] h-[72px]"
                style={{
                  width: "72px",
                  height: "72px",
                  ...
                  border: "1px none #60a5fa",
                }}
              >
                {question.icon2_path ? (
                  <img
                    src={question.icon2_path}
                    alt="emoji"
                    className="w-full h-full object-cover animate-emoji-pop-delayed"
                    style={{ opacity: 1 }}
                  />
                ) : (
                  <div
